				...
				<div class="grid grid-cols-1 xl:grid-cols-2 xl:gap-[100px] mt-[100px] xl:mt-0">
					<div class="">
						<div class="mb-[10px] flex items-center">
							<div class="w-[10px] h-[10px] bg-[#FF6B00] rounded-[10px] me-[10px]"></div>
						...
						<form class="grid grid-cols-2 gap-[30px]">
							<div class="relative border-b-[2px] border-b-[#454545]">
								...
								<div class="absolute top-0 right-0 bottom-0 left-0 z-[-1] bg-[#FF6B00] origin-left scale-x-0 peer-focus:scale-x-100 transition-all duration-[.5s] delay-[.25s] peer-focus:delay-0"></div>
							...
							<div class="flex">
								<button class="group h-[65px] relative items-center">
									<span class="absolute top-0 bottom-0 left-0 my-auto w-[65px] h-[65px] group-hover:left-[75%] group-hover:w-[20px] group-hover:h-[20px] rounded-[65px] bg-[#FF6B00] transition-all duration-[.5s]"></span>
